...
- **Dynamic Routing**: Seamless navigation using `react-router-dom` (Home, Shop, About, Login).
- **Theme Support**: Integrated Dark and Light mode with persistent state.
...
src/
 ...
 ├── constants/      # Static data (Product list, Theme colors)
 ├── pages/          # Page-level components (Home, Shop, About)
...
The vercel.json file ensures that all routes redirect to index.html to support Client-Side Routing.
Images are served from the public/assets/ directory for maximum compatibility.

👨‍💻 Author
Ashutosh Aman Full-Stack Developer & Lead Engineer.
